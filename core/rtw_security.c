...
static void sha256_init(struct rtw_rtw_sha256_state *md)
{
	md->curlen = 0;
	md->length = 0;
...
*/
static int sha256_process(struct rtw_rtw_sha256_state *md, unsigned char *in,
			  unsigned long inlen)
{
	unsigned long n;
...
/**
   ...
   @return CRYPT_OK if successful
*/
static int sha256_done(struct rtw_rtw_sha256_state *md, unsigned char *out)
{
	int i;
